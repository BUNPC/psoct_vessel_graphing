...
fnames = {'caa6-frontal_vessels-masked_crop',...
          'caa6-occipital_vessels-masked_crop',...
          'caa17_occipital_THRESH-0.5_crop',...
          'caa22-frontal_vessels-masked_crop',...
          'caa25-frontal_vessels-masked_crop',...
          'caa25-occipital_vessels-masked_crop',...
          'caa26-frontal_vessels-masked_crop',...
          'caa26-occipital_vessels-masked_crop'};
% filename extension
ext = '.tif';

function s = EllipseFit3DConstrained_jy(Vol, x, y, z, viewflag)
...
% Author: Amit Mukherjee
    ...
    while flag<2
        ...
        % save fitting process as gif or not
        if(viewflag==1)
            ...
            ShowLocalDataWithSE(Vol,s); 
            title(['Iter: ',num2str(i), ' Likelihood: ',num2str(s.L)]);
            frame = getframe(h); 
            im = frame2im(frame); 

...
% The synthetic data contain five cycles. The first four are sparse and the
% last is not sparse. The output of "graph_sparsity" should match the array
% below.
ground_truth = [1; 1; 1; 1; 0];

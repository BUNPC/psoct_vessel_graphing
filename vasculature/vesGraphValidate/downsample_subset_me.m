...
%
%{
This was initially developed for downsampling a group of parallel segments,
which were the output of the marching ellipsoid function. The marching
ellipsoid will not be used for the PSOCT data. This function is being
retained for posterity, in case the regraphing method becomes useful at a
later time.
